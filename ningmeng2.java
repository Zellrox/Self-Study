...
//给你一个“纯一个文件、无 package、适配 Corretto 16”的版本

下面这段代码你可以直接保存为 Main.java，然后在同一目录下放好老师给你的
HospitalInformation.java 和 MedicalNotification.java（也同样去掉 package），
然后用：

javac Main.java HospitalInformation.java MedicalNotification.java
java Main
